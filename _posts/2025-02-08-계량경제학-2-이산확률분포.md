---
title: 계량경제학 2 - 이산 확률 분포
date: 2025-02-08 00:05:00 +0900
categories: [경제학, 계량경제학]
tags: [econometrics, probability]
author: rachihyeon 
description: 계량경제학에서 주로 사용되는 이산 확률 분포인 베르누이 분포, 이항 분포, 푸이송 분포에 대해 다룬다.
# comments: 
# media_subpath: 
# pin: true
math: true
...
[이전 포스트](/posts/계량경제학-1-확률-review/)에서 확률 변수의 기댓값과 분산을 정의했는데 이산 확률 변수에 맞춰 표현하면,<br>
