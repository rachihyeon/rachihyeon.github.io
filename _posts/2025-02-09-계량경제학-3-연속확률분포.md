---
title: 계량경제학 3 - 연속 확률 분포
date: 2025-02-09 00:52:00 +0900
categories: [경제학, 계량경제학]
tags: [econometrics, probability]
    exponential distribution, chi-squared distribution, f distribution, beta distribution, student's t distribution, 연속 확률 분포, 균등 분포, 정규 분포, 표준 정규 분포, 지수 분포, 카이제곱 분포, F분포, 베타분포, t분포]
author: rachihyeon 
description: 계량경제학에서 주로 사용되는 연속 확률 분포에 대해 다룬다.
# comments: 
# media_subpath: 
# pin: true
math: true
...
[이산확률분포](/posts/계량경제학-2-이산확률분포/) 포스트와 마찬가지로 필요한 내용만 다루기 때문에 각 분포에 대해서 심오한 분석을 하지 않습니다. 

[계량경제학 포스트 보러가기](/categories/계량경제학/)

## 0. Prerequisite
[확률 변수, 확률 분포](/posts/계량경제학-1-확률-review/)에 대한 지식을 필요로 합니다.<br>
...
[확률 변수, 확률 분포](/posts/계량경제학-1-확률-review/)에서 확률 변수의 기댓값과 분산을 정의했는데 연속 확률 변수에 맞춰 표현하면,<br>
