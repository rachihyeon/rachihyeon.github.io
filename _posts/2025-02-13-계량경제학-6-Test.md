---
title: 계량경제학 6 - Test(검정)
date: 2025-02-13 00:30:00 +0900
categories: [경제학, 계량경제학]
tags: [econometrics, hypothesis testing]
author: rachihyeon 
description: 어떤 추정치가 유의한지에 대해 확인하는 검정(Test)이란 무엇이며 검정에 사용되는 검정 통계량은 어떤 것인지 알아본다.
# comments: 
# media_subpath: 
# pin: true
math: true
...
[지난 포스트](/posts/계량경제학-5-Gauss-Markov-Theorem/)에서 나중에 기회가 있으면 검정에 대해서 다룬다고 했는데, <br>
이렇게 빨리 다루게 될 줄은 몰랐습니다. 😅😅😅

기본적인 용어등은 [지난 포스트의 검정 섹션](/posts/계량경제학-5-Gauss-Markov-Theorem/)를 참고하시기 바랍니다.
...
>$$\hat{\beta}$$가 정규분포를 따른다는 것은 오차항 가정([A4](/posts/계량경제학-5-Gauss-Markov-Theorem/#2-1-classical-assumption))에 의한 것이다. <br>
