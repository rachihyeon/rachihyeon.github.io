---
title: 계량경제학 8 - Restricted OLS(ROLS), Chow test
date: 2025-02-15 15:10:00 +0900
categories: [경제학, 계량경제학]
tags: [econometrics, regression]
author: rachihyeon 
description: 규모에 따른 수익 모형을 예시로 들어 제약조건이 존재하는 상황에서 기존 모델의 추정치가 어떻게 되는지를 검정 통계량 관점에서 확인해보고 올바르게 추정치를 찾는 방법을 알아본다. 또, 연속적인 데이터 속에서 구조적인 변화의 존재 여부를 검정하는 chow test를 다룬다.
# comments: 
# media_subpath: 
# pin: true
math: true
...
우리는 이전에 [$$\sigma^2$$의 추정량](/posts/계량경제학-6-Test/#3-1-불편량)을 계산해내었다.
