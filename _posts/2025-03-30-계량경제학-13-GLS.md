---
title: 계량경제학 13 - GLS(Generalized least squares)
date: 2025-03-30 21:00:00 +0900
categories: [경제학, 계량경제학]
tags: [econometrics, regression]
author: rachihyeon 
description: 일반적인 모델에 대해서 등분산성 조건, 자기 상관성 없음 조건을 단번에 극복할 수 있는 GLS(Generalized least squares)방법에 대해서 알아보고 이게 왜 가능한지에 대해서 알아본다. 추가적으로 GLS의 단점을 극복하는 Cochrane-Orcutt Method에 대해서 알아본다.
# comments: 
# media_subpath: 
# pin: true
math: true
...
일반적인 DGP에서의 OLS estimator $$\hat{\beta}$$은 불변성, 일치성은 만족하지만 Best는 아니다. (그 이유가 궁금하다면 [여기](/posts/계량경제학-11-Heteroskedasticity/#1-등분산성-조건-제거)를 참고하길 바랍니다.)
