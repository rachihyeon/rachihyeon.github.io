...
그림으로 설명해보자면,
<img src="/assets/img/post_img/variable_relation_diagram.png" style="width:60%;">
원래 이론대로라면 위 그럼처럼 깔끔하게 $$X$$랑 $$\epsilon$$는 직교하며, 둘만으로 $$Y$$가 설명되어야 하나,

<img src="/assets/img/post_img/variable_relation_diagram_endogenous.png" style="width:60%;">
이 그림처럼 $$X$$와 $$\epsilon$$에 상관관계가 생겨 설명이 과소평가 혹은 과대평가 되는 문제가 발생하는 경우에 OLS estimator가 유효하지 않게 된다.<br>
따라서 도구변수 $$W$$를 추가하여 

<img src="/assets/img/post_img/variable_relation_diagram_IV.png" style="width:70%;">
